/datum/wires/autolathe
	holder_type = /obj/machinery/lathe/autolathe
...
/datum/wires/autolathe/interactable(mob/user)
	var/obj/machinery/lathe/autolathe/A = holder
	if(A.panel_open)
		return TRUE
...
/datum/wires/autolathe/on_pulse(wire)
	...
	switch(wire)
		if(WIRE_HACK)
			...
			addtimer(CALLBACK(A, /obj/machinery/lathe/autolathe.proc/reset, wire), 60)
		if(WIRE_SHOCK)
			A.shocked = !A.shocked
			A.shock(usr, 50)
			addtimer(CALLBACK(A, /obj/machinery/lathe/autolathe.proc/reset, wire), 60)
