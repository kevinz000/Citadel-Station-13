...
/obj/machinery/atmospherics/component/unary/portables_connector/layer1
	pipe_layer = 1
	icon_state = "connector_map-1"

/obj/machinery/atmospherics/component/unary/portables_connector/layer3
	pipe_layer = 3
	icon_state = "connector_map-3"

/obj/machinery/atmospherics/component/unary/portables_connector/visible
	level = 2

/obj/machinery/atmospherics/component/unary/portables_connector/visible/layer1
	pipe_layer = 1
	icon_state = "connector_map-1"

/obj/machinery/atmospherics/component/unary/portables_connector/visible/layer3
	pipe_layer = 3
	icon_state = "connector_map-3"
