...
/mob/living/ComponentInitialize()
	. = ..()
	RegisterSignal(src, list(SIGNAL_ADDTRAIT(TRAIT_MOBILITY_NOMOVE), SIGNAL_REMOVETRAIT(TRAIT_MOBILITY_NOMOVE)), .proc/update_mobility)
	RegisterSignal(src, list(SIGNAL_ADDTRAIT(TRAIT_MOBILITY_NOPICKUP), SIGNAL_REMOVETRAIT(TRAIT_MOBILITY_NOPICKUP)), .proc/update_mobility)
	RegisterSignal(src, list(SIGNAL_ADDTRAIT(TRAIT_MOBILITY_NOUSE), SIGNAL_REMOVETRAIT(TRAIT_MOBILITY_NOUSE)), .proc/update_mobility)
